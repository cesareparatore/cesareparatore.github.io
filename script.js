...
(() => {
  ...
  const updateTrajectoryTargets = () => {
     ...
     * Drift minimo.
     *
     * Non è un parallax scenografico.
     * È una variazione fisica quasi impercettibile
     * che mantiene la traiettoria viva.
     */
